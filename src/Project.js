  ...
  {!moreInfo ? (
    ...
    <div className='slideshow moreInfo'>
      ...
      <div className='project-buttons'>
        <Link className='a' to={githubRepo} target="_blank" rel="noopener noreferrer">GitHub Repo</Link>
        <Link className='a' to={deployLink} target="_blank" rel="noopener noreferrer">Deployed Site</Link>
